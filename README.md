...
It is designed to efficiently manage heap memory using advanced techniques such as segregated free lists and boundary tag coalescing.
...
├── examples/
│   └── demo.c             # Sample usage of allocator  
├── Makefile  
├── README.md  
